...
<div class="col-md-12">
    <form role="form" method="POST" action="<?php echo e(url('/provider/login')); ?>">
        ...
        <input id="email" type="email" class="form-control" name="email" value="<?php echo e(old('email')); ?>" placehold="<?php echo app('translator')->getFromJson('user.profile.email'); ?>" autofocus>
        ...
        <input id="password" type="password" class="form-control" name="password" placehold="<?php echo app('translator')->getFromJson('provider.signup.password'); ?>">
