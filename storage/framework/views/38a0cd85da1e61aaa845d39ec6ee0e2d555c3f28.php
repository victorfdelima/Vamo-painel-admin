        ...
        <div id="wrapper">
             ...
             <nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation">
                <ul class="nav sidebar-nav">
                    ...
                    <li class="full-white">
                        <a href="<?php echo e(url('/register')); ?>">SIGN UP TO RID</a>
                    </li>
                    <li class="white-border">
                        <a href="<?php echo e(url('/provider/register')); ?>">BECOME A DRIVER</a>
                    </li>
                    <li>
                        <a href="<?php echo e(url('/ride')); ?>">Rid</a>
                    </li>
                    <li>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12  col-md-6 sup-txt"><h2>Precisa de ajuda? Fale conosco</h2>
                                <div class="call-num">
                                    <h3 class=""><a href="mailto:<?php echo e(config('constants.contact_email', 'contato@dragon.com')); ?>">
                            ...
                            <div class="row app-dwon pad-60">
                                <div class="container pad-60">
                                    <div class="row center">
                                        ...
                                        <p class="white">Obtenha gratuitamente aplicativos para passageiros e motoristas para Android e iOS</p><br>
                                        <div class="">
