...
<div class="row white-section pad-60 no-margin">
    <div class="container">
        ...
        <div class="col-md-4 content-block small">
            ...
            <p>Você pode dirigir com o <?php echo e(config('constants.site_title', 'Moob Urban')); ?> a qualquer hora, dia ou noite, 365 dias por ano. As viagens não interferem na sua rotina, você faz seus horários, fique offline a qualquer momento.</p>
        </div>
    </div>
...
<div class="row gray-section no-margin full-section">
    <div class="container">                
        <div class="col-md-6 content-block">
            ...
            <a class="content-more more-btn" href="<?php echo e(url('login')); ?>">BAIXE O APP E COMECE AGORA <i class="fa fa-chevron-right"></i></a>
        </div>
...
<div class="row white-section pad-60 no-margin">
    <div class="container">
        ...
        <div class="col-md-4 content-block small">
            ...
            <h2>Segurança</h2>
            <div class="title-divider"></div>
            <p>Quando você dirige com <?php echo e(config('constants.site_title', 'Moob Urban')); ?>, você obtém suporte 24/7. Todos os corredores são verificados com suas informações pessoais e número de telefone. Assim, você saberá quem está viajando e nós também.</p>
        </div></div>
