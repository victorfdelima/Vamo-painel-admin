...
<!--            <div class="col-md-4">
            ...
            <div>
                <input id="service-number" type="text" class="form-control" name="service_number" value="<?php echo e(old('service_number')); ?>" placehold="<?php echo app('translator')->getFromJson('provider.profile.car_number'); ?>" data-validation="alphanumeric" data-validation-allowing=" -" data-validation-error-msg="<?php echo app('translator')->getFromJson('provider.profile.car_number'); ?> can only contain alphanumeric characters and - spaces">
            ...
            <div>
                <input id="service-model" type="text" class="form-control" name="service_model" value="<?php echo e(old('service_model')); ?>" placehold="<?php echo app('translator')->getFromJson('provider.profile.car_model'); ?>" data-validation="alphanumeric" data-validation-allowing=" -" data-validation-error-msg="<?php echo app('translator')->getFromJson('provider.profile.car_model'); ?> can only contain alphanumeric characters and - spaces">
